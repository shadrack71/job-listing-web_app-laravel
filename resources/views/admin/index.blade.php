...
$listingsLink = $userData['listingsLink'];
@endphp
                ...
                <table class="w-full table-auto rounded-sm">
                    <tbody>
                        ...
                        <tr class="border-gray-300">
                            ...
                            <td class="px-4 py-8 border-t border-b border-gray-300 text-lg">
                                <form action="{{route('destroyGig',['listing'=> $listing['id']])}}" method="post"
                                    name="deleteGig">
                                    @method("delete")
                                    @csrf
                                    <button type="submit"
            ...
            <div class="bg-gray-50 border border-gray-200 p-10 rounded">
                ...
                <table class="w-full table-auto rounded-sm">
                    <tbody>
                        ...
                        <tr class="border-gray-300">
                            <td class="px-4 py-8 border-t border-b border-gray-300 text-lg"> No users </td>
                        </tr>
