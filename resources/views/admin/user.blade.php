        ...
        <div class="mx-4">
            <div class="bg-gray-50 border border-gray-200 p-10 rounded">
                <div class="flex flex-col items-center justify-center text-center">
                    ...
                    <h2 class="text-2xl mb-2">{{$users->name}}</h2>
                    <h3 class="text-xl font-bold mb-4">{{$users->email}}</h3>
                    <h3 class="text-xl font-bold mb-4">{{$users->created_at}}</h3>


                    <table class="w-full table-auto rounded-sm">
                        <h3 class="text-xl font-bold mb-4">user posted listing</h3>
                        <tbody>
                                    ...
                                    <form action="{{route('destroyGig',['listing'=>$listing])}}" method="post"
                                        ...
                                        <button type="submit"
                                            class="block bg-black text-white py-2 rounded-xl hover:opacity-80"><i
                                                class="fa-solid fa-globe"></i> delete user</button>
                                    </form>
                                </td>
                            </tr>
                            @endforeach
